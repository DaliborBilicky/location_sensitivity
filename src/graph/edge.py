class Edge:
    """
    Represents an edge in a graph with a start vertex, an end vertex, and a cost associated with traversing the edge.
    """
    ...
    def __init__(self, v1: int, v2: int, cost: float):
        ...
        Args:
            ...
            cost (float): The cost associated with this edge. Can represent distance, weight, or any metric.
